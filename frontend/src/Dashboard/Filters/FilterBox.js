        ...
        .filter(
          (item, i) =>
            String(item.end_year)
              .toUpperCase()
              .includes(String(filterObj.end_year).toUpperCase()) &&
            item.topic.toUpperCase().includes(filterObj.topics.toUpperCase()) &&
            item.sector
              .toUpperCase()
            ...
            item.source.toUpperCase().includes(filterObj.source.toUpperCase())
        )
        .map((item) => {
          tempArray.push(item);
        })}
